                    ...
                    <table className='table'>
                        <tbody>
                        {
                            ...
                            return (<tr key={i} >
                                ...
                                <td className='nameAndImg' key={product.name}>{product.name} <img className='productImage' src={require(`./images/webshop/` + product.image + '.webp')} alt="The product in cart"></img> </td>
