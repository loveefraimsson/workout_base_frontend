    ...
    render() {
        ...
        return (
            <section className='productCard'>
                <Link onClick={this.scroll} className='productCardLink' key={name} to={{pathname:`/webshop/` + name , state: {product: this.state.product}}}><img className='productCardImage' src={require(`./images/webshop/` + image + '.webp')} alt="A product in the webshop"></img> <br />{name}</Link>
